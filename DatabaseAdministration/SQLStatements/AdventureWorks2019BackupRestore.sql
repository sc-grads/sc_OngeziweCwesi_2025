BACKUP DATABASE [AdventureWorks2019] TO  DISK = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLSERVER_2025\MSSQL\Backup\AdventureWorks2019_14032025.bak' WITH NOFORMAT, NOINIT,  NAME = N'AdventureWorks2019-Full Database Backup', SKIP, NOREWIND, NOUNLOAD,  STATS = 10
GO
...
USE [master]
RESTORE DATABASE [AdventureWorks2019] FROM  DISK = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLSERVER_2025\MSSQL\Backup\AdventureWorks2019_14032025.bak' WITH  FILE = 1,  NORECOVERY,  NOUNLOAD,  STATS = 10
